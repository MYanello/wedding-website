$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'f3a3cc4e1b8b4b0438505c0a38efad9f') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbzuJ1rLzWE1FLyhbkTY9qrRAXoOHfWJdPwS7FnjyaA9n--PAUmA7jNSriotixez_U0/exec', data)
                .done(function (data) {
                    console.log(data);
